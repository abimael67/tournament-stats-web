...
const StatsForm = ({ gameId, onSuccess, onCancel, editingStat = null }) => {
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({
                ...formData,
                field_goal_attempts: parseInt(e.target.value) || 0,
              })
            }
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500"
          />
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({
                ...formData,
                field_goal_made: parseInt(e.target.value) || 0,
              })
            }
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500"
          />
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({
                ...formData,
                three_point_attempts: parseInt(e.target.value) || 0,
              })
            }
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500"
          />
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({
                ...formData,
                three_point_made: parseInt(e.target.value) || 0,
              })
            }
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500"
          />
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({
                ...formData,
                free_throw_attempts: parseInt(e.target.value) || 0,
              })
            }
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500"
          />
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({
                ...formData,
                free_throw_made: parseInt(e.target.value) || 0,
              })
            }
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500"
          />
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({
                ...formData,
                technical_fouls: parseInt(e.target.value) || 0,
              })
            }
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500"
          />
...
const StatsTab = () => {
  ...
  const handleDeleteStat = async (statId) => {
    if (
      !confirm(
        "¿Estás seguro de que deseas eliminar esta estadística? Esta acción no se puede deshacer."
      )
    ) {
      return;
    }
  ...
  if (loading && games.length === 0)
    return <div className="text-center py-10">Cargando partidos...</div>;
  if (error)
            ...
            >
              {games.map((game) => (
                <option key={game.id} value={game.id}>
                  {new Date(game.date).toLocaleString("es-DO", {
                    year: "numeric",
                    month: "short",
                    day: "numeric",
                  })}{" "}
                ...
                <>
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-800 mb-4">
                      {selectedGameData.team_a.team_name}
                    </h3>
                    <div className="overflow-x-auto">
                      <table className="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                          {stats.filter(
                            (stat) =>
                              stat.player.team_id === selectedGameData.team_a.id
                          ).length === 0 ? (
                            <tr>
                              <td
                                colSpan="10"
                            ...
                            stats
                              ...
                              .map((stat) => (
                                <tr key={stat.id}>
                                  ...
                                  <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-500">
                                    {stat.field_goal_made}/
                                    {stat.field_goal_attempts}
                                  </td>
                                  <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-500">
                                    {stat.three_point_made}/
                                    {stat.three_point_attempts}
                                  </td>
                                  <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-500">
                                    {stat.free_throw_made}/
                                    {stat.free_throw_attempts}
                                  </td>
                                  <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-500">
                                    {stat.fouls}
                                  </td>
                          ...
                          <tr className="font-semibold">
                            ...
                            <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-900">
                              ...
                              {stats
                                ...
                                .reduce(
                                  (sum, stat) =>
                                    sum + (stat.field_goal_attempts || 0),
                                  0
                                )}
                            </td>
                            <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-900">
                              ...
                              {stats
                                ...
                                .reduce(
                                  (sum, stat) =>
                                    sum + (stat.three_point_attempts || 0),
                                  0
                                )}
                            </td>
                            <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-900">
                              ...
                              {stats
                                ...
                                .reduce(
                                  (sum, stat) =>
                                    sum + (stat.free_throw_attempts || 0),
                                  0
                                )}
                            </td>
                            <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-900">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-800 mb-4">
                      {selectedGameData.team_b.team_name}
                    </h3>
                    <div className="overflow-x-auto">
                      <table className="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                          {stats.filter(
                            (stat) =>
                              stat.player.team_id === selectedGameData.team_b.id
                          ).length === 0 ? (
                            <tr>
                              <td
                                colSpan="10"
