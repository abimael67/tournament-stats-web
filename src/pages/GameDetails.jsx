      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        >
          ...
          <div className="text-sm opacity-90">
            Total: {teamStats.totalPoints} pts | {teamStats.totalRebounds} reb |{" "}
            {teamStats.totalAssists} ast
          </div>
        </div>
              ...
              <div className="flex flex-col items-center text-center">
                <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-3">
                  ...
                  <div className="min-w-0">
                    <h3 className="text-lg sm:text-xl font-bold text-gray-900 truncate">
                      <a href={`/equipo/${game.team_a.id}`} translate="no">
                ...
                <div className="md:hidden mt-2">
                  ...
                  {game.winner_team_id === game.team_a.id && (
                    <div className="text-green-600 font-semibold text-xs mt-1">
                      GANADOR
                    </div>
                  )}
                </div>
              ...
              <div className="flex flex-col items-center text-center">
                <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-3">
                  <div className="min-w-0 sm:order-1">
                    <h3 className="text-lg sm:text-xl font-bold text-gray-900 truncate">
                      <a href={`/equipo/${game.team_b.id}`} translate="no">
