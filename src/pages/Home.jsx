    ...
    <div className="container mx-auto px-4 py-8">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-blue-800 mb-4">
          Torneo de Baloncesto entre Iglesias Adventistas de Santiago 2025
        </h1>
        <p className="text-xl text-gray-600">
          Estadísticas, calendario y más información sobre el torneo
        </p>
        <p className="text-sm text-gray-600">
          Torneo benéfico organizado por la Iglesia Adventista del Séptimo Día
          "Libertad"
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        >
          ...
          <p className="text-gray-600">
            Consulta los próximos partidos y resultados anteriores
          </p>
        </Link>
        ...
        >
          ...
          <p className="text-gray-600">
            Busca jugadores y consulta sus estadísticas
          </p>
        </Link>
              ...
              >
                <div className="p-6 text-white">
                  <div className="text-center mb-4">
                    ...
                    <div className="text-sm opacity-90">{game.place}</div>
                  ...
                  <div className="flex justify-between items-center">
                      ...
                      {game.team_a.logo_url ? (
                        ...
                        <div className="w-16 h-16 bg-white bg-opacity-20 rounded-full flex items-center justify-center mx-auto mb-2">
                          <span className="text-lg font-bold" translate="no">
                            {game.team_a.team_name.substring(0, 2)}
                          </span>
                        </div>
                      )}
                    ...
                    <div className="text-center flex-1">
                      {game.team_b.logo_url ? (
                        ...
                        <div className="w-16 h-16 bg-white bg-opacity-20 rounded-full flex items-center justify-center mx-auto mb-2">
                          <span className="text-lg font-bold" translate="no">
                            {game.team_b.team_name.substring(0, 2)}
                          </span>
                        </div>
                      )}
                      <div className="font-semibold text-sm" translate="no">
