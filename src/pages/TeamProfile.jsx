...
const TeamProfile = () => {
  ...
  const fetchTeamStatistics = async () => {
    try {
      ...
      setTeamStats({
        ...
        avgPointsFor: totalGames > 0 ? (totalPointsFor / totalGames).toFixed(1) : 0,
        avgPointsAgainst: totalGames > 0 ? (totalPointsAgainst / totalGames).toFixed(1) : 0,
        ...aggregatedStats
      });
  ...
  const getAssistant = () => members.find(member => member.role === 'assistant');
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {teamStats && (
        <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
          <h2 className="text-2xl font-bold text-blue-800 mb-6">Estadísticas del Equipo</h2>
          
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 mb-6">
            <div className="bg-blue-50 rounded-lg p-4 text-center">
              <div className="text-2xl font-bold text-blue-800">{teamStats.gamesPlayed}</div>
              <div className="text-sm text-gray-600">Partidos</div>
            </div>
            
            <div className="bg-green-50 rounded-lg p-4 text-center">
              <div className="text-2xl font-bold text-green-800">{teamStats.wins}</div>
              <div className="text-sm text-gray-600">Victorias</div>
            </div>
            
            <div className="bg-red-50 rounded-lg p-4 text-center">
              <div className="text-2xl font-bold text-red-800">{teamStats.losses}</div>
              <div className="text-sm text-gray-600">Derrotas</div>
            </div>
            
            <div className="bg-purple-50 rounded-lg p-4 text-center">
              <div className="text-2xl font-bold text-purple-800">{teamStats.winPercentage}%</div>
              <div className="text-sm text-gray-600">% Victorias</div>
            </div>
            
            <div className="bg-yellow-50 rounded-lg p-4 text-center">
              <div className="text-2xl font-bold text-yellow-800">{teamStats.avgPointsFor}</div>
              <div className="text-sm text-gray-600">Pts/Partido</div>
            </div>
            
            <div className="bg-gray-50 rounded-lg p-4 text-center">
              <div className="text-2xl font-bold text-gray-800">{teamStats.avgPointsAgainst}</div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center">
              <div className="text-lg font-semibold text-gray-800">{teamStats.totalPoints}</div>
              <div className="text-sm text-gray-600">Puntos Totales</div>
            </div>
            
            <div className="text-center">
              <div className="text-lg font-semibold text-gray-800">{teamStats.totalRebounds}</div>
              <div className="text-sm text-gray-600">Rebotes</div>
            </div>
            
            <div className="text-center">
              <div className="text-lg font-semibold text-gray-800">{teamStats.totalAssists}</div>
            ...
            <div className="text-center">
              <div className="text-lg font-semibold text-gray-800">
                {teamStats.totalFieldGoalAttempts > 0 
                  ? ((teamStats.totalFieldGoalMade / teamStats.totalFieldGoalAttempts) * 100).toFixed(1)
                  : 0}%
              </div>
      ...
      {/* Lista de jugadores */}
      <div className="bg-white rounded-lg shadow-lg p-6">
        <h2 className="text-2xl font-bold text-blue-800 mb-6">Plantilla de Jugadores</h2>
